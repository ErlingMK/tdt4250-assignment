 ...
 *   <li>{@link exercise.impl.ProgrammeImpl#getYears <em>Years</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProgrammeImpl extends MinimalEObjectImpl.Container implements Programme {
	...
	public EList<Year> getYears() {
		if (years == null) {
			years = new EObjectContainmentEList<Year>(Year.class, this, ExercisePackage.PROGRAMME__YEARS);
		}
		return years;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ExercisePackage.PROGRAMME__YEARS:
