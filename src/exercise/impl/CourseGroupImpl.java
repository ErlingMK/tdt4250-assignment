...
public class CourseGroupImpl extends MinimalEObjectImpl.Container implements CourseGroup {
	...
	protected EClass eStaticClass() {
		return ExercisePackage.Literals.COURSE_GROUP;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExercisePackage.COURSE_GROUP__NAME, oldName, name));
	}
	...
	public EList<Course> getCourses() {
		if (courses == null) {
			courses = new EObjectResolvingEList<Course>(Course.class, this, ExercisePackage.COURSE_GROUP__COURSES);
		}
		return courses;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExercisePackage.COURSE_GROUP__NAME:
				return getName();
